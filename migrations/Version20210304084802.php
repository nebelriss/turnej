 ...
 */
final class Version20210304084802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT NOT NULL, season_id INT NOT NULL, player_home_goals INT DEFAULT NULL, player_away_goals INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
